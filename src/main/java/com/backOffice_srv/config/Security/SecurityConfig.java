package com.backOffice_srv.config.Security;

import com.backOffice_srv.filter.JwtFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final String APP_ROOT = "/api_backoffice";
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http    .authorizeRequests()
                ...
                .antMatchers(APP_ROOT + "/blacklist/client").permitAll()
                .anyRequest()
                .authenticated()
